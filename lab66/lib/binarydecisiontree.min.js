!function(t, e) {
    ...
    new (function() {
        ...
        return a(t, [{
            ...
            value: function(t, e) {
                if (-1 === n.indexOf(t))
                    return console.error("Event: " + t + " is not registered"),
                    !1;
                var i = o[t].push(e);
                return function() {
                    return o[t].splice(i - 1, 1),
                    !0
                }
            }
        }, {
            key: "register",
            value: function(t) {
                return -1 !== n.indexOf(t) ? (console.error("Event: " + t + " has registered"),
                !1) : (n.push(t),
                o[t] = [],
                !0)
            }
            ...
            key: "emit",
            value: function(t, e) {
                return -1 === n.indexOf(t) ? (console.error("Event: " + t + " is not registered"),
                !1) : (o[t].forEach((function(t) {
            ...
            value: function(t) {
                var e = n.indexOf(t);
                return -1 === e ? (console.error("Event: " + t + " is not registered"),
                !1) : (n.splice(e, 1),
                delete o[t],
                !0)
            }
        ...
        return a(i, null, [{
            ...
            value: function(e, i) {
                return i || (i = 1),
                "object" == t(e) && e.target > .5 || "isTarget" === e || "boolean" == typeof e && e ? "rgba(37,37,166," + i + ")" : "rgba(219,4,4," + i + ")"
            }
        }, {
            ...
            value: function(t, e, i) {
                var a = [];
                return e[i].data_rows && (e[i].data_rows.true && (a = a.concat(e[i].data_rows.true)),
        ...
        function t(i) {
            ...
            this.trainingLine = this.trainingGroup.append("rect").attr("width", 300).attr("height", 1).attr("fill", "#ffffff"),
            this.trainingLabel = this.trainingGroup.append("text").text("訓練資料集").attr("fill","seashell").attr("text-anchor", "middle").attr("font-size", 18).attr("y", this.labelVerticalOffset).attr("x", 300),
            this.testGroup = this.g.append("g").attr("opacity", 0),
            this.testLine = this.testGroup.append("rect").attr("width", 300).attr("height", 1).attr("fill", "#ffffff"),
            this.testLabel = this.testGroup.append("text").text("測試資料集").attr("fill","seashell").attr("text-anchor", "middle").attr("font-size", 24).attr("y", this.labelVerticalOffset).attr("x", 300),
            this.testOpacity = 0,
            this.opacityInterpolator = d3.scale.linear().domain([1e5, 100100]).range([0, 1]).clamp(!0),
            this.results = {
                train: {
                    isTarget: {},
                    isNotTarget: {}
            ...
            this.smallTextNodes = [];
            var a = -8;
            this.textNodes.train.accuracy.text("0").attr("text-anchor", "middle").attr("y", a).attr("font-size", 26).attr("fill", "#ffffff"),
            this.trainingTargetDivider = this.trainingGroup.append("text").text("/").attr("text-anchor", "middle").attr("y", a).attr("font-size", 22),
            this.trainingNotTargetDivider = this.trainingGroup.append("text").text("/").attr("text-anchor", "middle").attr("y", a).attr("font-size", 22),
            this.textNodes.train.isTarget.correct.text("0").attr("text-anchor", "end").attr("fill", h.FILL_FN(!0)).attr("y", a).attr("font-size", 22),
            this.textNodes.train.isTarget.total.text("0").attr("text-anchor", "start").attr("fill", h.FILL_FN(!0)).attr("y", a).attr("font-size", 22),
            this.textNodes.train.isNotTarget.correct.text("0").attr("text-anchor", "end").attr("fill", h.FILL_FN(!1)).attr("y", a).attr("font-size", 22),
            this.textNodes.train.isNotTarget.total.text("0").attr("text-anchor", "start").attr("fill", h.FILL_FN(!1)).attr("y", a).attr("font-size", 22),
            ...
            this.textNodes.test.accuracy.text("0").attr("text-anchor", "middle").attr("y", a).attr("font-size", 26).attr("fill", "#ffffff"),
            this.testTargetDivider = this.testGroup.append("text").text("/").attr("text-anchor", "middle").attr("y", a).attr("font-size", 22),
            this.testNotTargetDivider = this.testGroup.append("text").text("/").attr("text-anchor", "middle").attr("y", a).attr("font-size", 22),
            this.textNodes.test.isTarget.correct.text("0").attr("text-anchor", "end").attr("fill", h.FILL_FN(!0)).attr("y", a).attr("font-size", 22),
            this.textNodes.test.isTarget.total.text("0").attr("text-anchor", "start").attr("fill", h.FILL_FN(!0)).attr("y", a).attr("font-size", 22),
            this.textNodes.test.isNotTarget.correct.text("0").attr("text-anchor", "end").attr("fill", h.FILL_FN(!1)).attr("y", a).attr("font-size", 22),
            this.textNodes.test.isNotTarget.total.text("0").attr("text-anchor", "start").attr("fill", h.FILL_FN(!1)).attr("y", a).attr("font-size", 22),
        ...
        return a(t, [{
            ...
            value: function(t) {
                ...
                this.width < 800 ? (this.largeTextSize = 18,
                this.smallTextSize = 16) : (this.largeTextSize = 26,
                this.smallTextSize = 22),
                this.largeTextNodes.forEach(function(t) {
                    t.attr("font-size", this.largeTextSize).attr("fill", "#ffffff")
                }
                .bind(this)),
                this.smallTextNodes.forEach(function(t) {
                    t.attr("font-size", this.smallTextSize).attr("fill", "#ffffff")
                }
                .bind(this)),
                this.labelVerticalOffset = -this.largeTextSize - 10,
            ...
            value: function() {
                ...
                isNaN(t) ? this.textNodes.train.accuracy.attr("opacity", 0) : this.textNodes.train.accuracy.attr("opacity", 1),
                ...
                isNaN(e) ? this.textNodes.test.accuracy.attr("opacity", 0) : this.textNodes.test.accuracy.attr("opacity", 1),
        ...
        function t(i) {
            ...
            this.tree.nodes.forEach(function(t) {
                var e, i, a = this.labelsGroup.append("g"), r = a.append("g"), s = r.append("g"), n = this.hoverGroup.append("g");
                t.key ? (e = t.value,
                i = t.key) : (e = "",
                i = "");
                var o = s.append("text");
                o.attr("text-anchor", "end").attr("x", 2 * -this.ballSpacing).attr("font-size", 11).attr("fill", "#ffffff").attr("y", 26).text(i + " <= " + e);
                var l = s.append("text");
                l.attr("x", 2 * this.ballSpacing).attr("font-size", 11).attr("fill", "#ffffff").attr("y", 26).text(i + " > " + e);
                var h, c, d = a.append("g"), u = a.append("g"), p = d.append("path").attr("fill", "none").attr("stroke-width", 3), f = u.append("path").attr("fill", "none").attr("stroke-width", 3), g = a.append("rect").attr("opacity", 0), y = a.append("rect").attr("opacity", 0);
                ...
                .bind(this)),
                c = n.append("rect").classed("rightHover", !0).attr("x", 0).attr("width", 60).attr("y", .6 * this.labelOffset).attr("height", 60).attr("opacity", 0).on("mouseenter", function() {
                    this.splitID = t.children[1].id,
                    this.rr = !0
                }
                .bind(this)).on("mouseleave", function() {
                    this.splitID = null,
        ...
        return a(t, [{
            ...
            value: function(t, e, i) {
                var a = []
                  , r = t.map(function(t) {
                    ...
                    .bind(this)).attr("fill", h.FILL_FN(t)).attr("stroke-width", 1).attr("stroke", h.FILL_FN(t)).attr("r", this.ballRadius),
                    a.push(t.index),
                    {
                        groupID: i,
                        attributes: t,
                ...
                r.forEach(function(t) {
                    ...
                    t.classification = i,
                    t.attributes.target > .5 ? t.correctlyClassified = "isTarget" === t.classification : t.correctlyClassified = "isNotTarget" === t.classification,
                ...
                s[0].forEach((function(t) {
                    var e = l;
                    t.correctlyClassified ? l++ : (e = n - c - 1,
                    c++);
                    var i = e % 5
                      , a = Math.floor(e / 5);
                    t.pileCoordinates = {
                ...
                return s[1].forEach((function(t) {
                    var e = d;
                    t.correctlyClassified ? d++ : (e = o - u - 1,
                    u++);
                    var i = e % 5
                      , a = Math.floor(e / 5);
                    t.pileCoordinates = {
            ...
            value: function(t, e, i) {
                ...
                t.treeCoordinates.forEach(function(t, e) {
                    ...
                    a += "L " + this.treeScales.x(t.x) + " " + this.treeScales.y(t.y) + " ",
                    a += "L " + this.treeScales.x(t.x) + " " + (this.treeScales.y(t.y) + this.labelOffset) + " "
                }
                .bind(this)),
                a += "L " + r + " " + this.treeScales.y(1.1) + " ";
                var s = this.baseline.training;
                if ("test" === t.groupID && (s = this.baseline.test),
                "isTarget" === t.classification) {
                    ...
                    n = this.treeScales.x(.02) + t.pileCoordinates.row * this.ballSpacing + this.ballSpacing / 2 * t.pileCoordinates.col,
                    o = t.pileCoordinates.col * this.ballSpacing * -.86 + s;
                    a += "L " + n + " " + o + " "
                }
                t.path.attr("d", a),
            ...
            value: function() {
                ...
                this.bounds.width > 850 ? (this.ballRadius = 3,
                this.ballSpacing = this.ballRadius + 5) : this.bounds.width > 650 ? (this.ballRadius = 2,
                this.ballSpacing = this.ballRadius + 4) : (this.ballRadius = 1.5,
                ...
                var e = {
                    ...
                    y: [.05 * this.bounds.height + this.ballSpacing, .7 * this.bounds.height]
                };
                this.treeScales = {
                ...
                this.splitLabels.forEach(function(t) {
                    ...
                    if (t.node.children) {
                        t.hoverLayer.attr("transform", "translate(" + e + ", " + i + ")"),
                        t.overlayLayer.attr("transform", "translate(" + e + ", " + i + ")");
                        var a = e - this.treeScales.x(t.node.children[0].x)
                          , r = this.treeScales.y(t.node.children[0].y) - i;
                        t.leftHover.attr("fill", "transparent").attr("opacity", 1).attr("x", -a).attr("y", .3 * r).attr("width", a).attr("height", r),
                        t.rightHover.attr("fill", "transparent").attr("opacity", 1).attr("y", .3 * r).attr("width", a).attr("height", r);
                        var s = this.treeScales.y(t.node.y) + this.labelOffset + this.ballSpacing
                          ...
                          , y = s + Math.sin(u) * c
                          , x = "";
                        x += "M " + e + " " + (i + this.labelOffset + this.ballSpacing) + " ",
                        x += "L " + p + " " + g + " ",
                        x += "L " + p + " " + (this.treeScales.y(t.node.children[0].y) + this.labelOffset - this.ballSpacing) + " ",
                        t.leftLine.attr("d", x);
                        var b = "";
                        if (b += "M " + e + " " + (i + this.labelOffset + this.ballSpacing) + " ",
                        b += "L " + f + " " + y + " ",
                        b += "L " + f + " " + (this.treeScales.y(t.node.children[0].y) + this.labelOffset - this.ballSpacing) + " ",
                        t.rightLine.attr("d", b),
                        !t.node.children[0].children) {
                            var v = h.FILL_FN("isTarget");
                            t.node.children[0].value[0] > t.node.children[0].value[1] && (v = h.FILL_FN("isNotTarget")),
                            t.leftLeaf.attr("opacity", 1).attr("x", p - 1).attr("y", g + 14).attr("fill", v).attr("width", 2).attr("height", 10)
                        }
                        if (!t.node.children[1].children) {
                            v = h.FILL_FN("isTarget");
                            t.node.children[1].value[0] > t.node.children[1].value[1] && (v = h.FILL_FN("isNotTarget")),
                            t.rightLeaf.attr("opacity", 1).attr("x", f - 1).attr("y", y + 14).attr("fill", v).attr("width", 2).attr("height", 10)
                        }
                    } else
                        t.overlayLayer.attr("style", "display: none;")
                }
                .bind(this)),
                this.baseline = {},
                this.baseline.training = .93 * this.bounds.height,
                this.baseline.test = this.baseline.training - 9 * this.ballSpacing;
                ...
                this.trainingSamples.forEach(function(t) {
                    ...
                    r - 3 * this.ballRadius < 0 ? (r = a - 3 * this.ballRadius,
                    s += 3 * this.ballRadius) : r -= 3 * this.ballRadius
                }
                .bind(this));
                ...
                this.testSamples.forEach(function(t) {
                    ...
                    n + 3 * this.ballRadius > i.width ? (n = a + 3 * this.ballRadius,
                    o += 3 * this.ballRadius) : n += 3 * this.ballRadius
                }
                .bind(this));
                var l = this.trainingSection.offsetTop - .1 * t
                  , c = .7 * t
                  , d = this.trainingSection.offsetTop + .7 * t
                  , u = d + .5 * t
                  , p = Math.round(t / 4)
            ...
            value: function(t, e) {
                ...
                i < 0 && (i = 0),
                i > t.pathLength ? (i = t.pathLength,
                t.done = !0) : t.done = !1;
                var a = t.path.node().getPointAtLength(i);
                return (t.x != a.x || t.y != a.y) && (t.x = a.x,
                t.y = a.y,
                t.rr = !0,
                !0)
            }
            ...
            value: function(t) {
                ...
                this.trainingSamples.forEach(function(i) {
                    ...
                    i.done && (e.train[i.classification].total++,
                    i.correctlyClassified && e.train[i.classification].correct++)
                }
                .bind(this)),
                this.testSamples.forEach(function(i) {
                    this.rr = this.updatePointPosition(i, t) || this.rr,
                    i.done && (e.test[i.classification].total++,
                    i.correctlyClassified && e.test[i.classification].correct++)
                }
                .bind(this)),
                ["train", "test"].forEach(function(t) {
                    ["isTarget", "isNotTarget"].forEach(function(i) {
                        e[t][i].total > 0 ? e[t][i].percent = Math.round(e[t][i].correct / e[t][i].total * 100) : e[t][i].percent = 0,
            ...
            value: function(t) {
                ...
                this.sampleID ? (this.sampleID == t.attributes.index && t.path.attr("opacity") <= 0 && t.path.attr("opacity", 1).attr("style", "display: initial"),
                this.sampleID != t.attributes.index && t.path.attr("opacity") > 0 && t.path.attr("opacity", 0).attr("style", "display: none")) : this.splitID && (t.waypoints.indexOf(this.splitID) >= 0 ? t.path.attr("opacity", .1).attr("style", "display: initial") : t.path.attr("opacity", 0).attr("style", "display: none")),
                this.sampleID || this.splitID || t.path.attr("opacity", 0).attr("style", "display: none")
            }
        }, {
            key: "render",
            value: function() {
                ...
                .bind(this)),
                this.splitLabels.forEach(function(t) {
                    this.splitID ? t.node.children && (this.splitID == t.node.children[0].id ? (t.leftText.attr("style", "display: block;"),
                    t.leftLine.attr("stroke", "#ffffff").attr("stroke-width", 2)) : (t.leftText.attr("style", "display: none;"),
                    t.leftLine.attr("stroke", "#ffffff").attr("stroke-width", 1)),
                    this.splitID == t.node.children[1].id ? (t.rightText.attr("style", "display: block;"),
                    t.rightLine.attr("stroke", "#ffffff").attr("stroke-width", 2)) : (t.rightText.attr("style", "display: none;"),
                    t.rightLine.attr("stroke", "#ffffff").attr("stroke-width", 1))) : (t.rightText.attr("style", "display: none;"),
                    t.leftText.attr("style", "display: none;"),
                    t.leftLine.attr("stroke", "#ffffff").attr("stroke-width", 1),
                    t.rightLine.attr("stroke", "#ffffff").attr("stroke-width", 1))
                }
                .bind(this))
            }
        }]),
    ...
    return function() {
        function t(i) {
            ...
            this.trainingSection = "string" == typeof r ? document.querySelector(r) : r,
            this.testSection = "string" == typeof s ? document.querySelector(s) : s
        }
        return a(t, [{
            ...
            value: function(t, e) {
                ...
                if ("function" != typeof e)
                    return new Promise((function(e, r) {
                        i.onload = function() {
                            a.data = JSON.parse(i.responseText),
                            e()
                        }
                        ,
                        i.open("GET", t),
